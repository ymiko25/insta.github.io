...
<div class="row gx-5">
    ...
    <div class="col-4">
        ...
        <div class="row align-items-center mb-5 bg-white shadow-sm rounded-3 py-3 mt-1">
            ...
            <div class="col ps-0">
                <a href="{{ route('profile.show', Auth::user()->id) }}" class="text-decoration-none text-dark fw-bold mb-0">
                    {{ Auth::user()->name }}
                </a>
              ...
              <div class="row align-items-center mb-3">
                   <div class="col-auto">
                       <a href="{{ route('profile.show', $user->id)}}">
                        ...
                        @else
                            <i class="fa-solid fa-circle-user text-decoration-none text-dark fw-bold icon-sm"></i>
                        @endif
                       </a>
                   </div>
